...
*Note: The logos presented in the UI mock-up are for demonstration purposes only. The deployed application will have the initials of the company names as icons instead.* 
