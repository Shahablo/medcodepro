...
We want to create an application for the end user to compare compensation for multiple jobs so that they can determine what the best opportunity for them is. 
...
Create a business case (is the project worth doing/what are the main risks/what are the criteria for success)
...
Create the project plan, showing different parts of the life cycle and entry/exit criteria/resource planning/end dates of phases)
...
**Deliverable 3 Construction (due 3/12/2023)**

 Here this is where most of the development of the prototype will occur. Here we will shift from intellectual property development to project development.  
...
**Deliverable 4 - Transition (due 3/19/2023)**
...
**Exit Criteria**
Users are satisfied with the end product
